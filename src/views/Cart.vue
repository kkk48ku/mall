    ...
    <div class="checkout cart-page">
        ...
        <div class="container">
            <div class="cart">
                ...
                <div class="item-empty-wrap" :class="{'notShowEmpty':notShowEmpty}">
                    ...
                    <ul data-v-c028c34c="" class="empty-item">
                        <li>
                            <div class="empty-info">暂无商品，请进入商品列表添加商品后再结算！</div>
                        </li>
                    </ul>
                </div>
                <div class="item-list-wrap" v-show="notShowEmpty">
                    <div class="cart-item">
                                    ...
                                    <div class="item-quantity">
                                        <div class="select-self select-self-open">
                                            <div class="select-self-area">
                                                <a class="input-sub" @click="editCart('dec',item)">-</a>
                ...
                <div class="cart-foot-wrap">
                    <div class="cart-foot-inner">
                        ...
                        <div class="cart-foot-r">
                            ...
                            <div class="btn-wrap">
                                <a class="btn btn--red" :class="{'btn-notChecked':notCheck}">Checkout</a>
                            </div>
                        </div>
                    </div>
                </div>
...
<style scoped>
    ...
    .item-empty-wrap .cart-empty-head {
        background: #605F5F;
        height: 40px;
        line-height: 40px;
        font-size: 15px;
    ...
    .item-empty-wrap .cart-empty-head ul li {
        float: left;
    ...
    .item-empty-wrap .cart-empty-head ul {
        display: contents;
    }

    .cart-empty-head ul li:nth-child(1) {
        width: 42%;
    }

    .cart-empty-head ul li:nth-child(2) {
        width: 12%;
    }

    .cart-empty-head ul li:nth-child(3) {
        width: 18%;
    }

    .cart-empty-head ul li:nth-child(4) {
        width: 18%;
    }

    .cart-empty-head ul li:nth-child(5) {
        width: 10%;
    }

    .item-empty-wrap .empty-item {
        height: 149px;
        line-height: 149px;
        text-align: center;
        font-size: 20px;
